...
// ATTRIBUTE_ACCESSORS(ClassName, PropertyName)을 선언하면 다음과 같은 함수들이 자동으로 생성된다.
// ex) GetHealthAttribute(), InitHealth(), GetHealth(), SetHealth()를 사용할 수 있다.  자세한 사항은 AttributeSet.h 참고.
